function outvalue=get_gamma_ab(x,target)
% function outvalue=get_gamma_ab(x,target)
% provides parameters a and b for gamma distribution that matches targets at
...
randnumbers=gamrnd(x(1),x(2),50000,1);
quant_values=quantile(randnumbers,[0.05,0.5,0.95]);
